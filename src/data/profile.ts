...
export const PROFILE: Profile = {
  ...
  tagline: 'Web を中心に、つくって公開するのが好きなエンジニアです。',
  avatarUrl, // ユーザー提供の実写真(webp・最適化済み)。自己紹介ページの avatar に表示。
  bio: [
    // ★仮の自己紹介文。本人確認後に差し替える(実績・所属などの具体は書かない)。
    'Web を中心にものづくりをしているエンジニアです。React や TypeScript が好きで、小さなアプリやツールをつくっては公開しています。',
    '最近は AI を使ったものづくりを楽しんでいます。このサイトも、掲載している楽曲も、AI との共同制作です。',
    'つくったものは GitHub で公開しています。気になるものがあれば、お気軽にご連絡ください。',
  ],
  skills: [
    // ★仮のスキル一覧。本人確認後に差し替える。
    {
  ...
  facts: [
    ...
    { label: '拠点', value: '日本' },
    { label: '主な領域', value: 'Web フロントエンド' },
    { label: '最近のテーマ', value: 'AI とのものづくり' },
  ],
};
